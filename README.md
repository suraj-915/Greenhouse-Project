...
Dynamic Sensor Timing: Uses the DHT_Unified library to calculate the optimal delay between sensor readings based on hardware specifications.
...
📊 Logic & CalibrationThe system calculates soil "Wetness" using the formula:Wetness = [(1023-SensorData)/1023] *100 
